...
df = pd.read_csv(r'C:\Users\Nitro 5\Desktop\EDAN70_CS_PROJECT\EDAN70_CS_PROJECT\matlab\table.csv',header=None)   #read the csv file (put 'r' before the path string to address any special characters in the path, such as '\'). Don't forget to put the file name at the end of the path + ".csv"
