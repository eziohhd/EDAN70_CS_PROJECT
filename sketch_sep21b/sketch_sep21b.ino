...
#define TILT_MIN  1024      //Minimum Tilt Servo Position
#define TILT_MAX  3072   //Maximum Tile Servo Position The 
#define MAPPED_TILT_MIN 1024  //Minimum Physical Position on a scale from 0-2048. Mapped value is the same as the TILT value for MX servos
#define MAPPED_TILT_MAX 3072 //Maximum Physical Position on a scale from 0-4096.  Mapped value is the same as the PAN value for MX servos

#define DEFAULT_SPEED1 64
#define DEFAULT_SPEED2 64
     ...
     if(servoMoving1 == 0)
      {
        ...
        {
        tiltGoalPositon = tiltCurrentPosition + 10;
